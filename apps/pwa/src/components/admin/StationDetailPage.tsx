    ...
    <div style={{ padding: '24px 16px', display: 'flex', flexDirection: 'column', gap: 24, minHeight: '100%' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', fontSize: 13, color: 'rgba(240,253,244,0.45)' }}>
              ...
              {station.macAddress && (<><span>·</span><span>MAC: <code style={{ color: '#22d3ee', fontFamily: 'var(--font-mono)' }}>{station.macAddress}</code></span></>)}
            </div>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
        <div className="glass-card" style={{ padding: 20 }}>
          <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(240,253,244,0.4)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>Nivel de Llenado Promedio</span>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 26, fontWeight: 800, color: avgLevel >= 80 ? '#fbbf24' : '#34d399', textShadow: '0 0 16px rgba(52,211,153,0.4)', marginTop: 8 }}>{avgLevel}%</div>
          <div style={{ fontSize: 11, color: 'rgba(240,253,244,0.4)', marginTop: 4 }}>Capacidad: {station.capacity} unidades</div>
        </div>
        <div className="glass-card" style={{ padding: 20 }}>
        ...
        <div className="glass-card" style={{ padding: 20 }}>
          <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(240,253,244,0.4)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>Clasificaciones hoy</span>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 26, fontWeight: 800, color: '#a3e635', textShadow: '0 0 16px rgba(163,230,53,0.4)', marginTop: 8 }}>{(station.today || 0).toLocaleString('es-ES')}</div>
          <div style={{ fontSize: 11, color: 'rgba(240,253,244,0.4)', marginTop: 4 }}>artículos procesados por IA</div>
        </div>
        <div className="glass-card" style={{ padding: 20 }}>
          <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(240,253,244,0.4)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>Estado Hardware IoT</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20 }}>
              ...
              return (
                <div key={m.label} style={{ padding: 14, borderRadius: 12, background: 'rgba(11,16,26,0.5)', border: `1px solid ${barColor}25` }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: 14, fontWeight: 700, color: barColor }}>{m.val}% {isAlert && <span style={{ fontSize: 10, color: '#fbbf24', marginLeft: 4 }}>⚠ Lleno</span>}</span>
                  </div>
        ...
        <div className="glass-card" style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
          <span style={{ fontSize: 11, fontWeight: 700, color: 'rgba(240,253,244,0.5)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Credenciales y Aprovisionamiento IoT</span>
          ...
          <div style={{ paddingTop: 16, borderTop: '1px solid rgba(99,231,182,0.08)' }}>
            <div style={{ fontSize: 11, color: 'rgba(240,253,244,0.4)', marginBottom: 12 }}>Al revocar los tokens, se invalidará la sesión actual en el backend (PostgreSQL) y se generarán nuevas credenciales criptográficas para reconfigurar el ESP32.</div>
