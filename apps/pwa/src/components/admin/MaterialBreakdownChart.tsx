...
import { SERIES, MONTHS, useApi } from '../../config/api';
...
export function MaterialBreakdownChart() {
  ...
  const dataMax = Math.max(...chartData.paper, ...chartData.plastic, ...chartData.metal, 0);
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ width: '100%', position: 'relative' }}>
        <svg
          ...
          style={{ width: '100%', height: 'auto', aspectRatio: '520/220', overflow: 'visible', display: 'block' }}
        >
          <defs>
