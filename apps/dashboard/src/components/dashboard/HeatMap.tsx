        ...
        return (
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
              <span style={{ fontSize: 16, fontWeight: 800, color: intensity.text, textShadow: `0 0 14px ${intensity.text}70`, letterSpacing: '-0.02em', lineHeight: 1 }}>
                {val}%
              </span>
            ...
            <span style={{ fontSize: 9.5, color: 'rgba(240,253,244,0.85)', fontWeight: 700, marginTop: 4, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '100%' }}>
              {z.name}
            </span>
            <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <span style={{ fontSize: 8.5, color: 'rgba(240,253,244,0.4)', fontFamily: 'var(--font-mono)' }}>{stationCount} est.</span>
            </div>
          </button>
        )
      })}
