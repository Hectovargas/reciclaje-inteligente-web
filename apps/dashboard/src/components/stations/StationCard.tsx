    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 15, fontWeight: 700, color: '#f0fdf4', marginTop: 6, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {station.name}
          </div>
      ...
      {station.macAddress && (
        <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 6, fontSize: 10, fontFamily: 'var(--font-mono)', color: 'rgba(240,253,244,0.45)' }}>
          <span>MAC:</span>
      ...
      {!isOffline && !isPending ? (
        <div style={{
          ...
          <div style={{ flex: '1 1 110px' }}>
            <div style={{ fontSize: 9.5, fontWeight: 700, color: 'rgba(240,253,244,0.4)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>
              Vaciado aproximado
            </div>
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 15, fontWeight: 800, color: maxBinLevel >= 80 ? '#fbbf24' : '#22d3ee' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 9.5, fontWeight: 700, color: '#38bdf8', textTransform: 'uppercase' }}>Zero-Touch Pairing</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 9.5, fontWeight: 700, color: 'rgba(239,68,68,0.8)', textTransform: 'uppercase' }}>Sin Conexión</div>
      ...
      <div style={{ marginTop: 14, paddingTop: 12, borderTop: '1px solid rgba(99,231,182,0.08)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <span style={{ fontSize: 9.5, fontWeight: 700, color: 'rgba(240,253,244,0.4)', letterSpacing: '0.07em', textTransform: 'uppercase' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6 }}>
          {[
            ...
            <div key={m.label} style={{
              ...
              background: 'rgba(11,16,26,0.5)', border: `1px solid ${m.val >= 80 ? '#fbbf24' : m.color}25`,
              display: 'flex', flexDirection: 'column', gap: 4,
            }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: 8.5, color: 'rgba(240,253,244,0.5)', fontWeight: 600 }}>{m.label}</span>
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, fontWeight: 700, color: m.val >= 80 ? '#fbbf24' : m.color }}>
                  {m.val}%
                </span>
              </div>
              <div style={{ height: 3, borderRadius: 1.5, background: 'rgba(240,253,244,0.08)', overflow: 'hidden' }}>
                <div style={{ height: '100%', borderRadius: 1.5, width: `${Math.min(100, m.val)}%`, background: m.val >= 80 ? '#fbbf24' : m.color }} />
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{ marginTop: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span style={{ marginLeft: 'auto', fontSize: 10.5, color: '#22d3ee', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
